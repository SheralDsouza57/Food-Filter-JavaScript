...
console.log("All the food items listed");
foodItems(data);
...
console.log("Food items sorted in descending order by protein content");
sortByprotein(data);
...
console.log("Food items sorted in ascending order by carb content");
sortByCab(data);
